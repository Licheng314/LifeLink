...
7. [`协作/任务-中央管理WebUI与Windows托盘拆分-2026-09-04.md`](协作/任务-中央管理WebUI与Windows托盘拆分-2026-09-04.md)：代码与 Windows 本机验收已完成的中央管理 WebUI 与 Windows 平台外壳拆分；Linux/Docker 的无桌面部署已在模块 README 单独交付，公网域名下的远程验收另列。
8. [`协作/任务-AI远程MCP接入与Python运行时-2026-09-04.md`](协作/任务-AI远程MCP接入与Python运行时-2026-09-04.md)：代码与自动化完成、待真实 HTTPS/远程 AI/云端 Docker 验收的远程 AI MCP、跨平台 Python 配对包和 Windows Python 3.13/3.14 运行时统一任务。
9. [`协作/任务-中央权威WebUI迁移规划-2026-09-04.md`](协作/任务-中央权威WebUI迁移规划-2026-09-04.md)：PC Dashboard 已迁移为中央权威 WebUI；PC 端现役范围仅为采集、上传、托盘、小窗与本地浏览器插件兼容。
10. [`协作/任务-每日时间区间-2026-09-05.md`](协作/任务-每日时间区间-2026-09-05.md)：待立项的每日重复时间区间规划，覆盖跨业务日、时间轴编辑、PC 提示、前台倒计时、AI 当前状态和既有睡眠/个人时光兼容；工作日/周末规则与音乐播放另行立项。
11. [`协作/任务-照片同步与业务日图库-2026-09-18.md`](协作/任务-照片同步与业务日图库-2026-09-18.md)：Android 获准相册浏览与显式勾选同步、中央来源设备隔离存储、WebUI 业务日图库和文字汇总事件；本阶段不向 AI 提供图片内容，也不包含 PC 图片上传。
...
| PC 客户端 | [`pc-dashboard/README.md`](../../pc-dashboard/README.md) | Windows 原生采集、可选浏览器插件、本地 outbox、中央连接、托盘和用时状态小窗 |
